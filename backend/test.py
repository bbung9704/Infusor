...
im = cv2.imread("images/test.jpeg")
...
im = cv2.circle(im, points_int[0], radius=0, color=(255,0,0), thickness=15)
im = cv2.circle(im, points_int[1], radius=0, color=(0,255,0), thickness=15)
im = cv2.circle(im, points_int[2], radius=0, color=(0,0,255), thickness=15)
result = cv2.circle(im, points_int[3], radius=0, color=(255,0,255), thickness=15)
